...
class New_Social_Media extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<div class="row text-center">	
			...
			<?php } ?>
			<?php if($email) { ?>
			<a href="mailto:<?php echo $email; ?>" class="social-envelope"><div class="nsmw-div-<?php echo $nsmw_widget_id; ?> <?php echo $columns; ?> <?php echo $hover_effects; ?>"><i class='fa fa-envelope-o fa-<?php echo $icon_size; ?>x' aria-hidden='true'></i></div></a>
			<?php } ?>
		</div>
		<?php
		...
		<div id="display-settings-<?php echo $nsmw_widget_id; ?>" style="display: none;">	
			...
			<p>
				...
				<select id="<?php echo esc_attr( $this->get_field_id( 'columns' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'columns' ) ); ?>">
					<option value="col-md-6" <?php if($columns == "col-md-6") echo "selected=selected"; ?>>2 Icon</option>
					<option value="col-md-4" <?php if($columns == "col-md-4") echo "selected=selected"; ?>>3 Icon</option>
					<option value="col-md-3" <?php if($columns == "col-md-3") echo "selected=selected"; ?>>4 Icon</option>
					<option value="col-md-2" <?php if($columns == "col-md-2") echo "selected=selected"; ?>>6 Icon</option>
					<option value="col-md-1" <?php if($columns == "col-md-1") echo "selected=selected"; ?>>12 Icon</option>
				</select>
			</p>
